...
cie_atr atr_list[] = {
        ...
        {CIE_Type::CIE_ACTALIS2, "Actalis2023", 	{ 0x80, 0x01, 0x80, 0x31, 0x80, 0x65, 0x49, 0x54, 0x4A, 0x34, 0x43, 0x12, 0x0F, 0xFF, 0x82, 0x90, 0x00, 0x8A }},
        {CIE_Type::CIE_BIT4ID,  "Bit4Id",   		{ 0x80, 0x01, 0x80, 0x31, 0x80, 0x65, 0x49, 0x54, 0x4A, 0x34, 0x42, 0x12, 0x0F, 0xFF, 0x82, 0x90, 0x00, 0x8B }},
        {CIE_Type::CIE_BIT4ID2,  "Bit4Id2023",  	{ 0x80, 0x01, 0x80, 0x31, 0x80, 0x65, 0x49, 0x54, 0x4A, 0x34, 0x44, 0x12, 0x0F, 0xFF, 0x82, 0x90, 0x00, 0x8D }},
...
string get_manufacturer(vector<uint8_t> atr) {
	...
	LOG_INFO("ReadCIEType - get_manufacturer() Unknown CIE detected");
	return "";
}
...
CIE_Type get_type(vector<uint8_t> atr) {
	...
	LOG_INFO("ReadCIEType - cie_type() Unknown CIE detected");
