...
namespace p11 {
	...
	bool CDecrypt::checkCache(const ByteArray &Data, ByteArray &Result)
	{
		init_func
	...
	void CDecrypt::setCache(const ByteArray &Data, ByteArray &Result)
	{
		init_func
			cacheData = Data;
		resultCache = Result;
	...
	void CDigestSHA::DigestUpdate(const ByteArray &Part) {
		init_func
			sha1.Update(Part);
	}
	...
	void  CDigestSHA::DigestSetOperationState(const ByteArray &OperationState)
	{
		init_func
			throw p11_error(CKR_FUNCTION_NOT_SUPPORTED);
	}
	...
	void CDigestMD5::DigestUpdate(const ByteArray &Part) {
		init_func
			md5.Update(Part);
	}
	...
	void CDigestMD5::DigestSetOperationState(const ByteArray &OperationState)
	{
		init_func
			throw p11_error(CKR_FUNCTION_NOT_SUPPORTED);
	}
