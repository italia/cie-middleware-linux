...
namespace p11 {
	...
	public:
		...
		virtual void DigestUpdate(const ByteArray &Part) = 0;
		...
		virtual void DigestSetOperationState(const ByteArray &OperationState) = 0;
	};
	...
	public:
		...
		ByteArray cacheData;
		bool checkCache(const ByteArray &Data, ByteArray &Result);
		void setCache(const ByteArray &Data, ByteArray &Result);
	};
